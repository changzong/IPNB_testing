...
if __name__ == '__main__':
    ...
    outputpath = sys.argv[2] + '\\pylintreport'
    ...
    for root, dirnames, filenames in os.walk(searchpath):
        for filename in fnmatch.filter(filenames, '*.py'):
            ...
            p = subprocess.Popen(["pylint", filepath, "--output-format=html", "--rcfile="+rcpath], shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
